...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Equipo Spatie en la app central (BD central, no pool)
    |--------------------------------------------------------------------------
    |
    | Con teams activo, hasRole('super_admin') exige que el pivot coincida con
    | setPermissionsTeamId(). En /admin no hay tenant Stancl: usamos este id
    | (p. ej. 0) como "equipo central". Debe coincidir con CentralShieldSeeder.
    |
    */

    'central_team_id' => env('PERMISSION_CENTRAL_TEAM_ID', 0),
